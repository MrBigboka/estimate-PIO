...
import { getComplexityInfo, truncateLabel, formatCurrency } from "@/utils";
                ...
                <Fragment key={index}>
                  ...
                  >
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      {phase.disableMaxMultiplier
                        ? `${phase.hoursMin}h`
                        : `${phase.hoursMin}h - ${phase.hoursMax}h`}
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      {phase.disableMaxMultiplier
                        ? `$${formatCurrency(phase.costMin)}`
                        : `$${formatCurrency(phase.costMin)} - $${formatCurrency(phase.costMax)}`}
                    </td>
                  ...
                  {expandedSteps[phase.id] && phase.subSteps && (
                    <tr className="bg-gray-50">
                      <td colSpan={4} className="px-6 pb-6">
                        ...
                        {phase.backendNotes && phase.backendNotes.length > 0 && (
